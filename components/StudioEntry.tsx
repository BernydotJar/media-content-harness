...
export default function StudioEntry({googleAvailable=false}:{googleAvailable?:boolean}) {
 const router = useRouter(), frame = useRef<HTMLElement>(null);
 const [busy,setBusy]=useState(false),[error,setError]=useState<ApiError|null>(null),[googleError,setGoogleError]=useState('');
