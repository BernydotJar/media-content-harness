...
export async function runSceneGenerationE2E({origin,accounts,temp,firstImage,acceptedImage,environmentImage,finalVideo}){
 ...
 try{
  ...
  await expect(page.getByRole('heading',{name:'Imagina la escena'})).toBeVisible()
  ...
  await page.getByLabel('Tipo de contenido').selectOption('video');await expect(page.getByLabel('Duración')).toHaveValue('6')
