...
const owner=account('firmes-owner',null,true),critic=account('firmes-critic','reviewer'),verifier=account('firmes-verifier','admin'),accounts={owner:owner.public,critic:critic.public,verifier:verifier.public}
